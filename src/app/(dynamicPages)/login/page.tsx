    ...
    return (
        <form className={styles.form_container}>
            ...
            <div className={styles.input_container}>
                ...
                <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" className={styles.input_field} id="email_field" />
            </div>
            <div className={styles.input_container}>
                ...
                <input placeholder="Password" title="Input title" name="input-name" type="password" className={styles.input_field} id="password_field" />
            </div>
